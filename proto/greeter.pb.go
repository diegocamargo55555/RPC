// Especifica a sintaxe do Protocol Buffers que estamos usando.
...
// O nome do pacote usado pelo Protocol Buffers.
...
// A mensagem de requisição, contendo o nome do cliente.
...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x124\n" +
	"\bSayHello\x12\x13.proto.HelloRequest\x1a\x11.proto.HelloReply\"\x00B+Z)github.com/seu-usuario/projeto-grpc/protob\x06proto3"
