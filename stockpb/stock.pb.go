...
// Mensagem de requisição do cliente
type QuoteRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Ticker string `protobuf:"bytes,1,opt,name=ticker,proto3" json:"ticker,omitempty"` // Ex: "AAPL", "GOOGL"
}
...
// Mensagem de resposta do servidor (que será enviada em stream)
type QuoteResponse struct {
	...
	Timestamp int64   `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Timestamp UNIX
}
...
func (x *QuoteResponse) GetTicker() string {
	if x != nil {
		return x.Ticker
	}
	return ""
...
var file_stock_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x63, 0x6b, 0x22, 0x26, 0x0a, 0x0c, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x22, 0x5b, 0x0a, 0x0d,
	...
	0x69, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x02,
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x52, 0x0a, 0x11, 0x53, 0x74, 0x6f,
	0x63, 0x6b, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d,
	0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x73,
	0x12, 0x13, 0x2e, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x51, 0x75,
	0x6f, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x13, 0x5a,
	0x11, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2d, 0x61, 0x70, 0x70, 0x2f, 0x73, 0x74, 0x6f, 0x63, 0x6b,
...
var file_stock_proto_goTypes = []interface{}{
	(*QuoteRequest)(nil),  // 0: stock.QuoteRequest
	(*QuoteResponse)(nil), // 1: stock.QuoteResponse
}
var file_stock_proto_depIdxs = []int32{
	0, // 0: stock.StockQuoteService.GetStockQuotes:input_type -> stock.QuoteRequest
	1, // 1: stock.StockQuoteService.GetStockQuotes:output_type -> stock.QuoteResponse
